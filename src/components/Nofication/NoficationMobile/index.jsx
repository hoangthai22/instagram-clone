...
const NoficationMobile = () => {
  const { setIsIconNofiDropdown, setIconProfile, setIconHome, setIconMessage, iconProfile, setisInviteMember, isShowModalMode, setIsShowModalMode } = useContext(AppContext);
  const {
    user: { uid },
